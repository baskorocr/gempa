...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'token'               => env('6055537452:AAGEX7C1jQ0hZBKLMJMbDUFKs8tFH52jb8k'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('https://api.telegram.org/bot6055537452:AAGEX7C1jQ0hZBKLMJMbDUFKs8tFH52jb8k/setWebhook'),
            'commands'            => [
